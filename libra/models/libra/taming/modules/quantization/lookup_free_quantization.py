...
class LFQ(Module):
    def __init__(
        ...
        *,
        ...
        codebook_size = default(codebook_size, lambda: 2 ** dim) # 512
        codebook_dim = int(log2(codebook_size)) # 9

        codebook_dims = codebook_dim * num_codebooks # 18
        dim = default(dim, codebook_dims) # 512
