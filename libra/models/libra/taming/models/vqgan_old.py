...
from libra.models.libra.taming.modules.vqvae.quantize import VectorQuantizer2 as VectorQuantizer
...
class VQModel(torch.nn.Module):
    def __init__(self,
        ...
        self.quant_conv = torch.nn.Identity() if self.use_clip else torch.nn.Conv2d(ddconfig["z_channels"], embed_dim, 1)
    ...
    def get_input_embeddings(self):
        return self.quantize.embedding
    ...
    def decode_code(self, code_b):
        quant_b = self.quantize.embedding(code_b).permute(0,3,1,2)
