...
from libra.models.libra.taming.data.conditional_builder.objects_bbox import ObjectsBoundingBoxConditionalBuilder
from libra.models.libra.taming.data.conditional_builder.objects_center_points import ObjectsCenterPointsConditionalBuilder
from libra.models.libra.taming.data.conditional_builder.utils import load_object_from_string
from libra.models.libra.taming.data.helper_types import BoundingBox, CropMethodType, Image, Annotation, SplitType
from libra.models.libra.taming.data.image_transforms import CenterCropReturnCoordinates, RandomCrop1dReturnCoordinates, \
...
class AnnotatedObjectsDataset(Dataset):
    ...
    def image_transform(self, x: Tensor) -> Tuple[Optional[BoundingBox], Optional[bool], Tensor]:
        crop_bbox = None
        flipped = None
